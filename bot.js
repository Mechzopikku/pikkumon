...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            ...
            chalk.green.bold('ᴘɪᴋᴋᴜᴍᴏɴ Running! 😎')
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______ 𝕡𝕚𝕜𝕜𝕦𝕞𝕠𝕟 _____🕊️♥️~*' +

                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Max Error oyvakkan Subscribe cheyyu https://youtube.com/channel/UCJURPkyz_UxRafwweAHsW1g'
                            ...
                            if (error.message.includes('URL')) {
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [♥️🕊️______ 𝕡𝕚𝕜𝕜𝕦𝕞𝕠𝕟 _____🕊️♥️] ⚕️*' + 
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [♥️🕊️______ 𝕡𝕚𝕜𝕜𝕦𝕞𝕠𝕟 _____🕊️♥️] ⚕️*' + 

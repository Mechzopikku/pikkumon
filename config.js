...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Pikkumon' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝕡𝕚𝕜𝕜𝕦𝕞𝕠𝕟' : process.env.BOT_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '918086567984,0' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "918086567984-1627138839",
